...
export default function ToolbarPlugin() {
  ...
  useEffect(() => {
    return mergeRegister(
      ...
      editor.registerCommand(
        SELECTION_CHANGE_COMMAND,
        (_payload: unknown, newEditor: LexicalEditor) => {
          updateToolbar();
          return false;
        },
        LowPriority
        ...
        <>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 4h-9m4 16H5m4-8h6m-6 0l4-8m-4 8l-4 8" />
                </svg>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 21h14M7 5v8a4 4 0 0 0 8 0V5" />
                </svg>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 12h12M9 5h6m-6 14h6" />
                </svg>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
